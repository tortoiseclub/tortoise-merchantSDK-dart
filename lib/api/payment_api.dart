...
class PaymentApi {
  ...
  ///
  /// 
  Future addPayment(Payment body) async {
  ...
  Future<List<Payment>> fetchAllPayments() async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<Payment>') as List).map((item) => item as Payment).toList();
    } else {
      return null;
    }
  }
  ...
  Future<Payment> getPayment(String paymentId) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'Payment') as Payment ;
    } else {
      return null;
    }
  }
